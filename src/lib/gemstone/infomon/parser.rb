    ...
    module Infomon
      ...
      module Parser
        module Pattern
          ...
          # @return [Regexp] Combined regex pattern for all parsing categories
        ...
        module State
          ...
          # @param state [Symbol] The state to set, must be one of Goals or Profile.
          # @raise [RuntimeError] If the state is invalid or if the state transition is not allowed.
          def self.set(state)
            case state
            when Goals, Profile
        ...
        # @param category [String] The category string to match against.
        # @return [String, nil] The matched category or nil if no match is found.
