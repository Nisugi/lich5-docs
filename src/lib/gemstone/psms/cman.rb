...
module Lich
  module Gemstone
    module CMan
      # Retrieves a list of combat maneuvers with their associated costs.
      #
      # @return [Array<Hash>] An array of hashes, each containing:
      #   - :long_name [String] The full name of the combat maneuver.
      #   - :short_name [String] The abbreviated name of the combat maneuver.
      #   - :cost [Integer] The cost associated with the maneuver.
      #
      # @example
      #   maneuvers = Lich::Gemstone::CMan.cman_lookups
      #   puts maneuvers.first[:long_name] # => "acrobats_leap"
      ...
      # Retrieves the assessment of a combat maneuver by name.
      #
      # @param name [String] the name of the combat maneuver
      # @return [Integer] the assessment score of the combat maneuver
      # @example
      #   CMan['Fireball'] # => 85
      def CMan.[](name)
      ...
      # Checks if a combat maneuver is known and meets the minimum rank requirement.
      #
      # @param name [String] the name of the combat maneuver
      # @param min_rank [Integer] the minimum rank to check against (default: 1)
      # @return [Boolean] true if the combat maneuver is known and meets the minimum rank, false otherwise
      # @example
      #   CMan.known?('Fireball', min_rank: 2) # => true
      # @note If min_rank is less than 1, it defaults to 1.
      def CMan.known?(name, min_rank: 1)
        min_rank = 1 unless min_rank >= 1 # in case a 0 or below is passed
        CMan[name] >= min_rank
      end

      # Checks if a combat maneuver is affordable.
      #
      # @param name [String] the name of the combat maneuver
      # @return [Boolean] true if the combat maneuver is affordable, false otherwise
      # @example
      #   CMan.affordable?('Fireball') # => true
      ...
      # @param min_rank [Integer] the minimum rank to check against (default: 1)
      # @return [Boolean] true if the combat maneuver is available, false otherwise
      # @example
      #   CMan.available?('Fireball') # => true
      # @note The method checks for cooldowns and debuffs before confirming availability.
      ...
      #
      # @param name [String] the name of the combat maneuver
      # @param target [String, Integer, GameObj] the target of the maneuver (default: "")
      # @param ignore_cooldown [Boolean] whether to ignore cooldowns (default: false)
      # @param results_of_interest [Regexp, nil] additional regex to match results (default: nil)
      # @return [String, nil] the result of the maneuver usage or nil if not available
      # @example
      #   CMan.use('Fireball', target: 'Goblin') # => "You cast Fireball at the Goblin."
      # @note The method will wait for roundtime and may retry if the maneuver is in cooldown.
      ...
      # @example
      #   CMan.regexp('Fireball') # => /Fireball/i
