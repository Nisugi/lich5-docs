...
module Lich
  ...
  module DragonRealms
    # Manages character equipment and gear, handling wearing/removing items and weapon management
    #
    # @author Lich5 Documentation Generator
    class EquipmentManager
      # Initializes a new EquipmentManager instance
      #
      # @param settings [Hash, nil] Equipment settings hash containing gear configurations
      # @return [EquipmentManager] New equipment manager instance
      def initialize(settings = nil)
        items(settings)
      end

      # Gets or loads equipment items from settings
      #
      # @param settings [Hash, nil] Equipment settings hash
      # @return [Array<DRC::Item>] Array of equipment items
      ...
      # Removes gear matching a given condition
      #
      # @param block [Proc] Block that evaluates whether an item should be removed
      # @return [Array<DRC::Item>] Array of removed items
      # @yield [DRC::Item] Yields each item to the block
      ...
      #
      # @param items_list [Array<DRC::Item>] List of items to wear
      # @return [void]
      ...
      # Wears a predefined equipment set
      #
      # @param set_name [String] Name of the equipment set to wear
      # @return [Boolean] True if all items were worn successfully, false otherwise
      # @note Will notify if any items are missing
      ...
      # Converts item descriptions to Item objects
      #
      # @param descs [Array<String>] Array of item descriptions
      # @return [Array<DRC::Item>] Array of matching Item objects
      ...
      #
      # @param description [String] Item description to match
      ...
      # Notifies about missing equipment
      #
      # @param lost_items [Array<DRC::Item>] Array of missing items
      # @return [void]
      # @note Plays a beep and pauses execution
      ...
      #
      # @param description [String] Description of weapon to wield
      # @param skill [String, nil] Weapon skill to swap to (optional)
      # @return [Boolean] True if weapon was wielded successfully
      # @example
      #   wield_weapon_offhand?("sword", "Heavy Edged")
      def wield_weapon_offhand?(description, skill = nil)
      ...
      # @return [Boolean] True if weapon was wielded successfully
      # @example
      #   wield_weapon?("sword", "Two-Handed Edged")
      def wield_weapon?(description, skill = nil)
        return unless description && !description.empty?
      ...
      # Checks if an item matches a description in the equipment list
      #
      # @param desc [String] Item description to check
      # @return [Boolean] True if item is in equipment list
      def is_listed_item?(desc)
        items.find { |item| item.short_regex =~ desc }
      end

      # Returns held items to their proper storage/worn positions
      #
      # @param gear_set [String] Name of gear set to reference (default: 'standard')
      # @return [Boolean] True if all items were stored successfully
      ...
      # Empties both hands by stowing or returning items
      #
      # @return [Boolean] True if hands were emptied successfully
      def empty_hands
      ...
      # Turns a weapon into a different form
      #
      # @param old_noun [String] Current weapon noun
      # @param new_noun [String] Desired weapon noun
      # @return [Boolean] True if weapon was transformed successfully
      # @example
      #   turn_to_weapon?("sword", "dagger")
      ...
      # Swaps a weapon to be used with a different skill
      #
      # @param noun [String] Weapon noun
      # @param skill [String] Desired weapon skill
      # @return [Boolean] True if weapon was swapped successfully
      # @example
      #   swap_to_skill?("sword", "Heavy Edged")
      ...
      # Unloads ammunition from a ranged weapon
      #
      # @param name [String] Name of weapon to unload
      # @return [void]
      # @note Handles storing ammunition appropriately
      ...
      # Stows a weapon or weapons in hands
      #
      # @param description [String, nil] Description of weapon to stow (nil stows both hands)
      # @return [void]
      # @note Handles unloading ranged weapons before stowing
      def stow_weapon(description = nil)
        ...
        if weapon.wield
          ...
          stow_helper("wear my #{weapon.short_name}", weapon.short_name, 'You sling', 'You attach', 'You .* unload', 'You slide', 'You place', 'close the fan', 'You hang', 'You spin', 'You strap', 'You put', 'You carefully loop', "You don't seem to