# Module containing DragonRealms Moon Mage specific functionality
# Provides methods for astronomical observations, divination, and moon magic
#
...
module Lich
  module DragonRealms
    module DRCMM
      ...
      # Observes a celestial object or the heavens
      #
      # @param thing [String] The celestial object to observe, or 'heavens'
      # @return [String] The result of the observation attempt
      # @example
      ...
      # Makes a prediction about something
      #
      # @param thing [String] What to predict about, use 'all' for complete prediction
      # @return [String] The result of the prediction attempt
      # @example
      #   DRCMM.predict('all')
      ...
      # Studies the sky for portents
      #
      # @return [String] The result of studying the sky
      # @example
      #   DRCMM.study_sky
      def study_sky
      ...
      # @param storage [Hash] Storage configuration with 'tied' and/or 'container' keys
      # @return [Boolean] True if telescope retrieved successfully
      # @example
      #   DRCMM.get_telescope?('telescope', {'container' => 'backpack'})
      ...
      # @param telescope_name [String] The name of the telescope (default: 'telescope')
      # @param storage [Hash] Storage configuration with 'tied' and/or 'container' keys
      # @return [Boolean] True if telescope stored successfully
      # @example
      #   DRCMM.store_telescope?('telescope', {'tied' => 'belt'})
      ...
      # Centers telescope on a specific target
      #
      # @param target [String] The celestial object to center on
      # @return [String] Result of the centering attempt
      # @note Will attempt to open telescope if closed
      # @example
      ...
      # Aligns with a magical skill
      #
      # @param skill [String] The skill to align with
      # @return [String] Result of the alignment attempt
      # @example
      #   DRCMM.align('pg')
      def align(skill)
      ...
      # Handles divination using various tools
      #
      # @param tool_storage [Hash] Configuration for the divination tool
      # @return [void]
      # @example
      #   DRCMM.use_div_tool({'name' => 'bones', 'container' => 'backpack'})
      ...
      # Attempts to wear a summoned moon weapon
      #
      # @return [Boolean] True if successfully wore a moon weapon
      # @example
      ...
      # Drops any held moon weapons
      #
      # @return [Boolean] True if successfully dropped a moon weapon
      # @example
      ...
      # Checks if holding a moon weapon
      #
      # @return [Boolean] True if holding any moon weapon
      # @example
      #   DRCMM.holding_moon_weapon?
      ...
      # Determines which moon was used to summon current weapon
      #
      # @return [String, nil] Name of moon used or nil if no weapon found
      # @note Only reliable with one summoned weapon
      # @example
      ...
      # Updates astral data for spellcasting
      #
      # @param data [Hash] Spell data to update
      # @param settings [Object] Settings object containing telescope configuration
      # @return [Hash] Updated spell data
      # @example
      #   DRCMM.update_astral_data(spell_data, settings)
      ...
      # Finds currently visible planets
      #
      # @param planets [Array<String>] List of planets to check
      # @param settings [Object] Settings object containing telescope configuration
      # @return [Array<String>] List of currently visible planets
      # @example
      #   DRCMM.find_visible_planets(['xibar', 'yavash'], settings)
      ...
      # Checks if any bright celestial object is visible
      #
      # @return [Boolean] True if sun or bright moon is visible
      # @note Requires moonwatch script to be running
      # @example
      #   DRCMM.bright_celestial_object?
      ...
      #
      # @param moon_name [String] Name of moon to check
      # @return [Boolean] True if specified moon is visible
      # @example
      #   DRCMM.moon_visible?('katamba')
      def moon_visible?(moon_name)
        visible_moons.include?(moon_name)
      end

      # Gets list of currently visible moons
      #
      # @return [Array<String>] Names of visible moons
      # @note Requires moonwatch script to be running
      # @example
      #   DRCMM.visible_moons
      def visible_moons
