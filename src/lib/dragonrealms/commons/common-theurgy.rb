...
module Lich
  # Module containing DragonRealms-specific code
  module DragonRealms
    # Module containing helper methods for Cleric/Theurgy-related actions in DragonRealms
    # @author Lich5 Documentation Generator
    module DRCTH
      module_function

      # List of common items used in cleric rituals and ceremonies
      ...
      # Common error messages encountered during commune attempts
      ...
      # Ordered list of devotion level messages from lowest to highest
      # @return [Array<String>] Array of devotion level messages
      DEVOTION_LEVELS = [
      ...
      # Checks if holy water is available in the specified container
      #
      # @param theurgy_supply_container [String] The container holding supplies
      # @param water_holder [String] The vessel containing holy water
      # @return [Boolean] true if holy water is present, false otherwise
      # @example
      #   has_holy_water?('backpack', 'vial')
      ...
      # Checks if flint is present in the specified container
      #
      ...
      # Checks if holy oil is present in the specified container
      #
      # @param theurgy_supply_container [String] The container to check
      ...
      # Checks if incense is present in the specified container
      #
      # @param theurgy_supply_container [String] The container to check
      ...
      # Checks if jalbreth balm is present in the specified container
      #
      # @param theurgy_supply_container [String] The container to check
      ...
      # Determines if a cleric item requires blessing when purchased in a specific town
      #
      # @param town [String] The name of the town
      # @param item_name [String] The name of the item
      # @return [Boolean, nil] true if blessing required, false if not, nil if unknown
      # @example
      #   buying_cleric_item_requires_bless?('Crossing', 'holy water')
      ...
      # Purchases cleric items from a shop in the specified town
      #
      # @param town [String] The name of the town
      # @param item_name [String] The name of the item to buy
      # @param stackable [Boolean] Whether the item can be stacked
      # @param num_to_buy [Integer] Number of items to purchase
      # @param theurgy_supply_container [String] Container to store items
      # @return [Boolean] true if purchase successful, false otherwise
      # @example
      #   buy_cleric_item?('Crossing', 'incense', true, 3, 'backpack')
      ...
      # Blesses an item using the Bless spell
      #
      # @param item_name [String] The name of the item to bless
      # @note Requires knowing the Bless spell
      # @example
      ...
      # Empties both hands of any cleric items into the specified container
      #
      # @param theurgy_supply_container [String] Container to store items
      # @example
      #   empty_cleric_hands('backpack')
      ...
      #
      # @param theurgy_supply_container [String] Container holding supplies
      # @param water_holder [String] The vessel containing holy water
      # @param target [String] The target to sprinkle water on
      # @return [Boolean] true if successful, false otherwise
      # @example
      #   sprinkle_holy_water?('backpack', 'vial', 'altar')
      ...
      #
      # @param theurgy_supply_container [String] Container holding supplies
      # @param target [String] The target to sprinkle oil on
      # @return [Boolean] true if successful, false otherwise
      # @example
      #   sprinkle_holy_oil?('backpack', 'altar')
      ...
      #
      # @param theurgy_supply_container [String] Container holding supplies
      # @param target [String] The target to apply balm to
      # @example
      #   apply_jalbreth_balm('backpack', 'wounds')
      ...
      # Waves lit incense at a target
      #
      # @param theurgy_supply_container [String] Container holding supplies
      # @param flint_lighter [String] The flint item used to light incense
      # @param target [String] The target to wave incense at
      # @return [Boolean] true if successful, false otherwise
      # @example
      #   wave_incense?('backpack', 'flint', 'altar')
      ...
      # Checks the status of active and recent communes
      #
      # @return [Hash] Hash containing:
      #   - active_communes: [Array<String>] Currently active communes
      #   - recent_communes: [Array<String>] Recently performed communes
      #   - commune_ready: [Boolean] Whether new communes can be performed
      # @example
      #   status = commune_sense
      #   puts status['active_communes']
      def commune_sense
